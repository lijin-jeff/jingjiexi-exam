    ...
    <div class="article-lists">
        <el-card class="!border-none" shadow="never">
            <el-form ref="formRef" class="mb-[-16px]" :model="queryParams" :inline="true">
                ...
                <el-form-item label="所属题库" class="w-[280px]">
                    <el-select v-model="queryParams.exam_category_uid">
                ...
                <!-- 是否是外部链接 -->
                <el-form-item label="是否是外部链接" class="w-[280px]">
                    <el-select v-model="queryParams.is_external_link">
                        <el-option label="全部" value />
        ...
        <el-card class="!border-none mt-4" shadow="never">
            ...
            <el-table size="large" v-loading="pager.loading" :data="pager.lists">
                ...
                />
                <el-table-column label="所属题库" prop="exam_category_title" min-width="120" />
