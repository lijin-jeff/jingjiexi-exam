            ...
            <el-form class="mb-[-16px]" :model="queryParams" inline>
                ...
                <el-form-item label="激活状态" prop="active_status">
                    <el-select
                        class="w-[280px]"
                        style="width: 120px"
                        v-model="queryParams.active_status"
                        clearable
                        placeholder="请选择激活状态"
                    >
            ...
            <div class="mt-4">
                <el-table :data="pager.lists" @selection-change="handleSelectionChange">
                    ...
                    <el-table-column label="结束时间" prop="end_time">
                        <template #default="{ row }">
                            <span>{{
                                row.end_time ? timeFormat(row.end_time, 'yyyy-mm-dd hh:MM:ss') : ''
                            }}</span>
                        </template>
                    </el-table-column>
                    <el-table-column label="激活状态" prop="active_status">
                        <template #default="{ row }">
                            <dict-value
                                :options="dictData.activite_status"
                                :value="row.active_status"
                            />
                        </template>
                    </el-table-column>
                    <el-table-column label="ID" prop="id" show-overflow-tooltip />
                    <el-table-column label="激活码" prop="active_code" show-overflow-tooltip />
...
import { apiTenantExamActiveDelete, apiTenantExamActiveLists } from '@/api/exam/tenant_exam_active'
