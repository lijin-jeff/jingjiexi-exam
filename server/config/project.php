...
return [
    ...
    // 商城用户token（登录令牌）配置
    'user_token' => [
        'expire_duration' => 3600 * 24 * 30,//用户token过期时长(单位秒）= 30天
        'be_expire_duration' => 3600 * 24 * 7,//用户token临时过期前时长，自动续期 = 7天
    ],
    ...
    'default_image' => [
        'admin_avatar' => 'resource/image/common/avatar.png',
        'user_avatar' => 'static/userinfo_avatar.png',
    ...
    'ai' => [
        // 豆包 API 密钥
        'doubao_api_key' => env('ai.doubao_api_key', ''),
        // 豆包模型名称
        'doubao_model' => env('ai.doubao_model', 'doubao-seed-1-8-251228'),
        // 豆包 API 地址
        'doubao_api_url' => env('ai.doubao_api_url', 'https://ark.cn-beijing.volces.com/api/v3/responses'),
    ]
