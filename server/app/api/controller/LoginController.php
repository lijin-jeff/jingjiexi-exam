...
public array $notNeedLogin = ['register', 'account', 'logout', 'codeUrl', 'oaLogin', 'mnpLogin', 'silentLogin', 'getScanCode', 'scanLogin', 'forgetUpdatePassword'];
     ...
     */
        ...
        {
            $validate = new LoginAccountValidate();

            // 使用新的验证方法
            $validationResult = $validate->validateAndReturnErrors($this->request->param());
            
            // 如果验证失败，返回错误信息
            if ($validationResult !== true) {
                return $this->fail($validationResult['msg']);
            }
