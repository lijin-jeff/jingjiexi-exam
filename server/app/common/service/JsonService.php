...
class JsonService
{
    ...
    //     return self::result($code, $show, $msg, $data);
    // }
    public static function fail(string $msg = 'fail', array $data = [], int $code = 0, int $show = 1, int $httpStatus = 200): Json
{
   return self::result($code, $show, $msg, $data, $httpStatus);
}
    ...
    {
        //return self::success('',[$lists->lists()],1,0);
        //获取导出信息
        ...
        //print_r($data);
        return self::success('success', $data, 1, 0);
    }
}