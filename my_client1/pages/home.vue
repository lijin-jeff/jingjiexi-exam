  ...
  <view class="template-advertise">
    ...
    <view class="adver-wrap tn-bg-white">
      ...
      <view class="detail-img tn-padding">
        <tn-swiper :list="detailImages" height="1000" mode="number" :autoplay="true" :interval="3000" :radius="20" :effect3d="true"/>
      </view>
...
<script>
  ...
  export default {
    ...
    data(){
      return {
        detailImages: [
          {image: 'https://datiqiniu.allpp.cn/index/1.jpg', title: 'BUG再多'},
          {image: 'https://datiqiniu.allpp.cn/index/2.jpg', title: '精解析答题'},
          {image: 'https://datiqiniu.allpp.cn/index/3.jpg', title: '一起玩转scss'},
	  {image: 'https://datiqiniu.allpp.cn/index/4.jpg', title: 'BUG再多'},
	  {image: 'https://datiqiniu.allpp.cn/index/5.jpg', title: '精解析答题'},
	  {image: 'https://datiqiniu.allpp.cn/index/6.jpg', title: '一起玩转scss'},
	  {image: 'https://datiqiniu.allpp.cn/index/7.jpg', title: 'BUG再多'},
	  {image: 'https://datiqiniu.allpp.cn/index/8.jpg', title: '精解析答题'},
	  {image: 'https://datiqiniu.allpp.cn/index/9.jpg', title: '一起玩转scss'},
	  {image: 'https://datiqiniu.allpp.cn/index/10.jpg', title: 'BUG再多'},
	  {image: 'https://datiqiniu.allpp.cn/index/12.jpg', title: '精解析答题'},
	  {image: 'https://datiqiniu.allpp.cn/index/13.jpg', title: '一起玩转scss'},
        ],
        cardCur: 0,
        swiperList: [{
          id: 0,
    ...
    computed: {
      ...
      serviceQrCode() {
        return getApp().globalData.serviceQrCode || getApp().globalData.otherSettings?.service_qr_code || '';
      },
      customerWechat() {
        return getApp().globalData.customerWechat || getApp().globalData.otherSettings?.customer_wechat || '';
      },
      customerName() {
        return getApp().globalData.customerName || getApp().globalData.otherSettings?.customer_name || '官方客服';
      },
      customerCompany() {
        return getApp().globalData.customerCompany || getApp().globalData.otherSettings?.customer_company || '精解析题库';
      },
      customerPosition() {
        return getApp().globalData.customerPosition || getApp().globalData.otherSettings?.customer_position || '高级工程师';
      },
      copyright() {
        return getApp().globalData.copyRight || getApp().globalData.otherSettings?.copyright || '';
      },
      defaultAvatar() {
        return getApp().globalData.defaultAvatar || getApp().globalData.otherSettings?.default_avatar || '';
      }
    },
    async onLoad() {
